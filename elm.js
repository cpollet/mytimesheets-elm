...
var $author$project$Main$init = {o: _List_Nil};
...
var $author$project$Main$toHour = function (string) {
	var _v0 = $elm$core$String$toInt(string);
	if (!_v0.$) {
		var i = _v0.a;
		return ((i < 0) || (i > 23)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(i);
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Main$toMinute = function (string) {
	var _v0 = $elm$core$String$toInt(string);
	if (!_v0.$) {
		var i = _v0.a;
		return ((i < 0) || (i > 59)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(i);
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Main$toTime = function (str) {
	toTime:
	while (true) {
		if (!A2($elm$core$String$contains, ':', str)) {
			var $temp$str = A2($elm$core$String$left, 1, str) + (':' + A2($elm$core$String$dropLeft, 1, str));
			str = $temp$str;
			continue toTime;
		} else {
			...
			if (!_v0.b) {
				...
				if (!_v0.b.b) {
					var h = _v0.a;
					var _v1 = $author$project$Main$toHour(h);
					if (!_v1.$) {
						var hour = _v1.a;
						return $elm$core$Maybe$Just(
							{t: hour, u: 0});
					...
					if (!_v0.b.b.b) {
						...
						var _v2 = _v0.b;
						var m = _v2.a;
						var _v3 = $author$project$Main$toHour(h);
						if (!_v3.$) {
							var hour = _v3.a;
							if (m === '') {
								return $elm$core$Maybe$Just(
								...
								var _v5 = $author$project$Main$toMinute(m);
								if (!_v5.$) {
									var minute = _v5.a;
									return $elm$core$Maybe$Just(
										{t: hour, u: minute / 60});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var rowIndex = msg.a;
		var value = msg.b;
		var _v1 = $author$project$Main$toTime(value);
		if (_v1.$ === 1) {
			return model;
		} else {
			var t = _v1.a;
			...
			if (rowIndex.$ === 1) {
				...
				return {
					o: _Utils_ap(
						A2($elm$core$List$take, i, model.o),
						_Utils_ap(
							_List_fromArray(
								[item]),
							A2($elm$core$List$drop, i + 1, model.o)))
				};
			}
		}
	});
...
var $author$project$Main$ValidateTime = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
...
var $author$project$Main$onBlurWithTargetValue = function (tagger) {
	return A2(
...
var $author$project$Main$placeholderOrValue = F2(
	function (string, placeholderText) {
		if (string === '') {
			return $elm$html$Html$Attributes$placeholder(placeholderText);
		} else {
			return $elm$html$Html$Attributes$value(string);
		}
	});
...
var $author$project$Main$renderTime = function (time) {
	return $elm$core$String$fromInt(time.t) + (':' + A2(
		$elm$core$String$right,
		2,
		'0' + $elm$core$String$fromFloat(time.u * 60)));
};
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Main$renderTime(entry.I)),
									$author$project$Main$onBlurWithTargetValue(
									$author$project$Main$ValidateTime(
										$elm$core$Maybe$Just(rowIndex)))
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$Main$placeholderOrValue, entry.H, 'description')
								]),
							_List_Nil)
						])),
...
var $author$project$Main$renderRows = function (model) {
	return $elm$core$List$concat(
		_List_fromArray(
			[
				A2($elm$core$List$indexedMap, $author$project$Main$renderRow, model.o),
				_List_fromArray(
				[
					A2(
					$elm$html$Html$tr,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$placeholder('h:mm'),
											$author$project$Main$onBlurWithTargetValue(
											$author$project$Main$ValidateTime($elm$core$Maybe$Nothing))
										]),
									_List_Nil)
								])),
							A2(
